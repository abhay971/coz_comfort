          ...
          <div className="flex flex-wrap lg:justify-start justify-between items-center py-3 text-sm">
            ...
            >
              <div className="flex items-center gap-2 mb-2 sm:text-base text-xs">
                <span className="text-[#F37E3A] font-bold">10+</span>
                <span className="text-gray-600">years of experience</span>
                <span className="text-gray-300">|</span>
              </div>
              <div className="flex items-center gap-2 mb-2 sm:text-base text-xs">
                <span className="text-[#F37E3A] font-bold">500+</span>
            ...
            <div className="lg:absolute right-0 bottom-16 flex lg:flex-col flex-row-reverse lg:gap-0 gap-4">
              ...
              >
                <span className="text-[#F37E3A] font-semibold">100+</span>
              ...
              >
                {/* <span className="text-[#F37E3A] font-bold">Industry</span>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            <h1 className="sm:text-4xl md:text-5xl text-2xl !leading-[110%] font-semibold text-gray-900 mb-8">
              ...
              >
                Building Industrial Spaces That Drive Growth.
              </VerticalCutReveal>
            </h1>
            ...
            >
              ...
              >
                <p className="leading-relaxed text-justify">
                  COZ COMFORT specializes in creating industrial infrastructure
                  that empowers businesses to thrive. From concept to
                  completion, we deliver spaces designed for efficiency, growth,
              ...
              >
                <p className="leading-relaxed text-justify">
                  Every project represents our commitment to excellence in
                  industrial development. By combining innovative design with
                  practical functionality, we create spaces that meet your
          ...
          <div className="md:col-span-1">
            <div className="text-right">
              {/* <TimelineContent
                ...
                timelineRef={heroRef}
                customVariants={revealVariants}
                className="text-[#F37E3A] text-2xl font-bold mb-2"
              >
                COZ COMFORT
              </TimelineContent> */}
              <TimelineContent
              ...
              >
                Industrial Development | Infrastructure Solutions
              </TimelineContent>
