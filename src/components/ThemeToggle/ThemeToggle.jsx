...
const ThemeToggle = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hover Effect */}
      <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#F37E3A]/20 to-[#288EC2]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
    </button>
  );
};
