      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            Scroll through each phase to explore our comprehensive approach to industrial infrastructure
          </p>
        </div>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-[#F37E3A] via-[#288EC2] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
