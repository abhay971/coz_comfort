  ...
  return (
    <>
        ...
        <div className={`relative z-10 grid lg:grid-cols-2 gap-4 lg:gap-0 min-h-screen transition-all duration-1000 ${
          ...
          <div className={`relative py-8 lg:py-0 transition-all duration-1000 delay-300 ${
            ...
            <div className="absolute inset-4 lg:inset-8 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="hidden sm:block absolute bottom-8 right-8 max-w-xs bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 shadow-lg">
            ...
            <div className="block sm:hidden mt-4 mx-4 bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 shadow-lg">
      ...
      <section 
        ...
        className="min-h-screen bg-white text-gray-800 flex items-center justify-center px-8"
      >
        <div className={`max-w-6xl mx-auto transition-all duration-1000 ${
          ...
          <div className="grid grid-cols-2 lg:grid-cols-2 gap-16 lg:gap-32">
            ...
            <div className="text-center">
              <div className="text-4xl sm:text-6xl lg:text-8xl xl:text-9xl font-light mb-4 text-gray-800 transition-all duration-100 ease-out" style={{fontFamily: 'Georgia, serif'}}>
                {counts.sqft}k
              </div>
              <div className="text-xs sm:text-sm font-light tracking-widest text-gray-500 uppercase">
                sq. ft.<br />
            ...
            <div className="text-center">
              <div className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-light mb-4 text-gray-800 transition-all duration-100 ease-out" style={{fontFamily: 'Georgia, serif'}}>
                {counts.residences}
              </div>
              <div className="text-xs sm:text-sm font-light tracking-widest text-gray-500 uppercase">
        ...
        <div className="relative z-10 min-h-screen flex items-center">
          <div className="max-w-7xl mx-auto px-8 lg:px-16">
            <div className={`max-w-2xl transition-all duration-1200 ${
              ...
              <h2 className="text-5xl lg:text-7xl font-light leading-tight text-gray-800 mb-8" style={{fontFamily: 'Georgia, serif'}}>
                A VISION OF<br />
                INSPIRED<br />
                INDUSTRY
              </h2>
              ...
              <button className="bg-gray-800 text-white hover:bg-gray-700 px-8 py-3 font-medium rounded-full transition-colors">
                DISCOVER MORE
              </button>
            </div>
          </div>
      ...
      <section 
        ...
        className="min-h-screen bg-white text-gray-800 relative"
      >
        ...
        <div className="relative z-10 min-h-screen flex items-center py-20">
          <div className="max-w-7xl mx-auto px-8">
            <div className={`grid lg:grid-cols-3 gap-8 h-full transition-all duration-1000 ${
              ...
              {/* Row 1 */}
              <div className="bg-white backdrop-blur-sm rounded-2xl p-8 border border-gray-200 hover:bg-gray-50 shadow-md transition-all duration-300">
