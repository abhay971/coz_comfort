...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show header after scrolling past hero section (viewport height)
  ...
  // Don't render header at all when not scrolled
  ...
  return (
    <nav className="fixed w-full top-0 z-50 transition-all duration-500 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-8 lg:space-x-12">
              ...
              <a href="#process" className="text-gray-800 hover:text-[#F37E3A] font-semibold tracking-wider uppercase text-sm transition-all duration-300 relative group">
                Process
                <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#F37E3A] group-hover:w-full transition-all duration-300"></div>
              </a>
              ...
              <a href="#contact" className="text-gray-800 hover:text-[#F37E3A] font-semibold tracking-wider uppercase text-sm transition-all duration-300 relative group">
                Contact
                <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#F37E3A] group-hover:w-full transition-all duration-300"></div>
              </a>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-4 pt-4 pb-6 space-y-3 bg-white/95 backdrop-blur-md border-t border-gray-200">
              <a
                href="#about-section"
